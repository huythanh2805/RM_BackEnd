...
export const MoMopayment = async (req, respond) => {
  ...
  var redirectUrl = "https://golden-fork.onrender.com/thanks";
  var ipnUrl = "https://api-golden-fork.onrender.com/api/payment/ipnUrl";
  ...
  req = https.request(options, (res) => {
    ...
    res.on("data", (body) => {
      ...
      respond.status(201).json({ message: "Successfully!", data: JSON.parse(body) });
    });
    res.on("end", () => {
